...
public:
	...
	void getValues(TactileValue::Mode mode, OutputIterator first, OutputIterator last,
	...
	float accumulate(const AccessorFunction& accessor, AccMode mode = Sum, bool bMean = true) const;
